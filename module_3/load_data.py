...
Usage::
    ...
    python load_data.py                          # loads llm_extend_applicant_data.json
...
DEFAULT_INPUT = Path(__file__).resolve().parent / "data" / "llm_extend_applicant_data.json"
