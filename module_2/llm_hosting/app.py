...
# module_2 edit: resolve the canon files next to this script instead of the
# current working directory, so app.py can be driven from ../clean.py.
_HERE = os.path.dirname(os.path.abspath(__file__))
CANON_UNIS_PATH = os.getenv("CANON_UNIS_PATH", os.path.join(_HERE, "canon_universities.txt"))
CANON_PROGS_PATH = os.getenv("CANON_PROGS_PATH", os.path.join(_HERE, "canon_programs.txt"))
...
def _load_llm() -> Llama:
    ...
    # NOTE (module_2 edit): `local_dir_use_symlinks` and `force_filename` were
    # removed from huggingface_hub >= 0.26 and raise TypeError; the model is
    # cached under llm_hosting/models/ relative to this file so the script
